...
export function InstallPrompt() {
  ...
  return (
    <div
      ...
      className="fixed bottom-4 left-4 right-4 sm:left-auto sm:right-4 sm:max-w-sm z-50 rounded-xl border border-border bg-card text-card-foreground shadow-2xl p-4 animate-in slide-in-from-bottom-4 duration-500"
    >
      <button
        type="button"
